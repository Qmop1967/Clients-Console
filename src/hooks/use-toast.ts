...
type ToasterToast = ToastProps & {
  ...
  variant?: "default" | "success" | "destructive" | "warning" | "info" | "cart";
};
...
const toastCart = (title: string, description?: string) => {
  return toast({ title, description, variant: "cart" });
};

export { useToast, toast, toastSuccess, toastError, toastWarning, toastInfo, toastCart };
