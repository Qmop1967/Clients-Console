...
export function PublicBottomNav({ onMenuClick }: PublicBottomNavProps) {
  ...
  return (
    <nav className="tsh-bottom-nav shrink-0 z-50 border-t border-border/30 bg-background/98 backdrop-blur-xl supports-[backdrop-filter]:bg-background/90 safe-area-bottom md:hidden">
