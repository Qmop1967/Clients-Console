...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[8.25rem] end-4 z-40 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-lg shadow-emerald-900/30 transition-transform native-press hover:scale-105 md:bottom-[5.25rem] md:end-6"
    >
