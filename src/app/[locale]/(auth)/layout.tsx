import { BrandConstellation } from "@/components/auth/brand-constellation";
...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/50 to-cyan-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 via-sky-400/10 to-cyan-400/10 animate-gradient-shift" />

      {/* Floating orbs for depth */}
      <div className="absolute -top-20 -left-20 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl animate-float-slow" />
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-sky-400/15 rounded-full blur-3xl animate-float-slower" />
