...
import { getCustomerPayments } from "@/lib/odoo/payments";
...
async function fetchPayments(
  ...
  try {
    return await getCustomerPayments(odooPartnerId, page, 25);
  } catch (error) {
...
export default async function PaymentsPage({
  ...
  const paymentsResponse = await fetchPayments(session.user.odooPartnerId, currentPage);
