// GET /api/consignments/visits/[id]/document/print — تقرير الجرد والمطابقة
...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const res = await gwFetch(`/api/client/consignments/visits/${id}/document/print`, { partnerId, actorToken });
    if (!res.ok) {
    ...
    console.error("[Consignment Visit print Proxy]", e);
