// GET /api/consignments/visits/[id]/document — تقرير الجرد والمطابقة
...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const res = await gwFetch(`/api/client/consignments/visits/${id}/document`, { partnerId, actorToken });
    if (!res.ok) {
    ...
    console.error("[Consignment Visit document Proxy]", e);
