...
export async function POST(request: NextRequest) {
  try {
      ...
      return NextResponse.json({
        ...
        data: {
          ...
          user: {
            ...
            odoo_partner_id: DEMO_USER.odooPartnerId,
    ...
    const customer = await getCustomerFresh(customerBasic.contact_id) || customerBasic;
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        user: {
          ...
          company_name: null,  // Not available from API contact
          odoo_partner_id: mobileUser.odooPartnerId,
